...
const UploadHrVivaMark = (candidate) => {
    ...
    const handleSubmit = () => {
        ...
        axios.post("/api/evaluation/upload-mark/hr-viva", formData, config)
            .then((response) => {
    ...
    return (
        <MarksContainer>
            ...
            {`Upload HR Viva mark of ${candidate?.candidate.examineeInfo?.userInfo?.firstName}`}
            </Typography>
...
export default UploadHrVivaMark